...
2. Auto-generate 2-4 word branch name from description
3. Determine next feature number by scanning `.prizmkit/specs/` and existing branches
4. Create git branch: `###-feature-name`
5. Create directory: `.prizmkit/specs/###-feature-name/`
6. Read Prizm docs (`.prizm-docs/root.prizm`) for project context
7. Generate `spec.md` from template (`${SKILL_DIR}/assets/spec-template.md`) focusing on:
...
8. Generate `checklists/requirements.md` (spec quality checklist)
9. Run internal quality validation loop (max 3 iterations):
...
10. Output: `spec.md` path and summary
